...
\begin{frame}{The "Psychological Markup" on Waiting (BDM)}
    ...
    % 合并定义与计算来源
    \textbf{Definition}: The weight assigned to 1 unit of biological delay. \\
    ...
    \vfill
    \textit{This markup explains why hesitancy persists even for \alert{high-efficacy} or "perfect" vaccines.}
\end{frame}
...
% -----------------------------------------------------------------------------
% SECTION V: BROADER RESEARCH & SKILL SETS
% -----------------------------------------------------------------------------
\section{Broader Research Portfolio \& Skill Sets}

\begin{frame}{Research Portfolio: Beyond the Dissertation}
    \begin{itemize}
        \item \textbf{Completed Studies (Dissertation)}
            \begin{itemize}
                \item Essay 1: Recovering structural parameters for vaccination delay.
                \item Essay 2: Monetary valuation (MWTA) and "Shadow Price of Waiting."
                \item Essay 3: Equity-sensitive allocation of speed-ups vs. compensation.
            \end{itemize}
        \item \textbf{Ongoing \& Planned Studies (Expanding Scope)}
            \begin{itemize}
                \item \textbf{Project 4}: \textit{Addiction \& Intertemporal Choice} --- Structural modeling of present-bias in \alert{Tobacco and Cannabis cessation}.
                \item \textbf{Project 5}: \textit{Digital Health Equity} --- Quantifying the \alert{"Cognitive Time-Tax"} of Medicaid-targeted health nudges.
            \end{itemize}
        \item \textbf{Impact}: Using structural modeling to design incentive-compatible policies for \alert{high-risk behavioral health}.
    \end{itemize}
\end{frame}

\begin{frame}{The Behavioral Toolbox: Methodological Strengths}
    \begin{itemize}
        \item \textbf{Structural Econometrics}: 
            \begin{itemize}
                \item FIML/Simulated Likelihood; recovering latent preference parameters.
                \item Handling complex choice data with unobserved heterogeneity.
            \end{itemize}
        \item \textbf{Experimental Design}: 
            \begin{itemize}
                \item Advanced DCEs (D-efficient); Developing novel, policy-ready metrics.
                \item Field-ready incentive-compatible mechanisms.
            \end{itemize}
        \item \textbf{Data Science \& Evaluation}:
            \begin{itemize}
                \item \alert{Large-scale data engineering} (scraping, panel management).
                \item \alert{Causal inference} (DiD, RDD) applied to behavioral policy.
            \end{itemize}
        \item \textbf{Computational Mastery}: R (Expert), Stata, Python.
    \end{itemize}
\end{frame}

\begin{frame}{Future Alignment: The "Shi Lab" Synergy}
    \begin{itemize}
        \item \textbf{Substance Use Policy}: Applying structural discounting models to tobacco, cannabis, and opioid cessation timing.
        \item \textbf{Digital Health \& Equity}: Optimizing nudge-based policy for marginalized populations (Medicaid/Low-income).
        \item \textbf{Collaboration Goal}: 
            \textit{Bridging behavioral structural rigor with UCSD's high-impact health policy evaluation.}
    \end{itemize}
\end{frame}
